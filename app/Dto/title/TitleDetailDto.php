...
class TitleDetailDto implements JsonSerializable
{
    public ?int $id;
    public ?int $userId;
    public ?int $roleId;
     ...
     */
    public function __construct(?int $id = null, ?int $userId = null, ?int $roleId = null,  ?string $description = null, ?int $sortOrder = null, ?string $roleName = null
    ...
    public static function createEmpty() : TitleDetailDto {
        return new self();
    }

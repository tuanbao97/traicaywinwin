...
namespace App\Dto\categoryN;

class CategoryNDetailDto implements \JsonSerializable
{
    ...
    /**
     * @var array<CategoryNDetailDto>|null
     */
    ...
    public function jsonSerialize(): mixed {
        return [
            ...
            , 'TEN_DANH_MUC_TIN_TUC' => $this->name
            , 'TEN_DANH_MUC_TIN_TUC_SLUG' =>  convertStrToSlug($this->name)

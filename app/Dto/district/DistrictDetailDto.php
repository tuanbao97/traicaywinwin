...
class DistrictDetailDto implements JsonSerializable
{
    public ?string $code;
    public ?string $name;
    ...
    public static function createEmpty() : DistrictDetailDto {
        return new self();
    }
    ...
    public function jsonSerialize(): mixed {
        return [
            'CODE' => $this->code
            , 'TEN_QUAN_HUYEN' => $this->name
            , 'TEN_QUAN_HUYEN_SLUG' => $this->nameSlug
            , 'TYPE' => $this->type

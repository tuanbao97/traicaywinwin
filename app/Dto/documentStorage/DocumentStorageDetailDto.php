...
class DocumentStorageDetailDto implements \JsonSerializable
{
    public ?int $id;
    public ?string $name;
    ...
    public function __construct(?int $id = null, ?string $name = null, ?string $originalName = null, ?string $extension = null
        ...
        , ?int $sortOrder = null, ?string $type = null, ?bool $isThumnail = null, ?string $aspectRatio = null
        ...
        , ?String $attr1 = null, ?String $attr2 = null
    )
    {
        $this->id = $id;
        $this->name = $name;
    ...
    public static function createEmpty(): DocumentStorageDetailDto {
        return new DocumentStorageDetailDto();
    }

...
namespace App\Dto\province;

use JsonSerializable;

class ProvinceDetailDto implements JsonSerializable
{
    public ?string $code;
    public ?string $name;
     ...
     */
    public function __construct(?string $code = null, ?string $name = null, ?string $nameSlug = null, ?string $type = null, ?int $sortOrder = null, ?string $parentCode = null
    ...
    public static function createEmpty() : ProvinceDetailDto {
        return new self();
    }
    ...
    public function jsonSerialize(): mixed {
        return [
            'CODE' => $this->code
            , 'TEN_TINH_THANH' => $this->name
            , 'TEN_TINH_THANH_SLUG' => $this->nameSlug
            , 'TYPE' => $this->type

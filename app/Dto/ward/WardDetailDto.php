...
class WardDetailDto implements JsonSerializable
{
    public ?string $code;
    public ?string $name;
    ...
    public static function createEmpty() : WardDetailDto {
        return new self();
    }
    ...
    public function jsonSerialize(): mixed {
        return [
            'CODE' => $this->code
            , 'TEN_PHUONG_XA_THI_TRAN' => $this->name
            , 'TEN_PHUONG_XA_THI_TRAN_SLUG' => $this->nameSlug
            , 'TYPE' => $this->type

...
class RoleDetailDto implements \JsonSerializable
{
    public ?int $id;
    public ?string $code;
    public ?string $name;
     ...
     */
    public function __construct(?int $id = null, ?string $code = null, ?string $name = null, ?string $nameSlug = null,  ?string $description = null
    ...
    public static function createEmpty() : RoleDetailDto {
        return new self();
    }
    ...
    public function jsonSerialize(): mixed {
        return [
            'ID' => $this->id
            , 'MA_VAI_TRO' => $this->code
            , 'TEN_VAI_TRO' => $this->name
            , 'TEN_VAI_TRO_SLUG' => $this->name

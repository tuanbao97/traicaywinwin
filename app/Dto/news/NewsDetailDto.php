...
class NewsDetailDto implements \JsonSerializable
{
    public ?int $id;
    public ?string $title;
    ...
    public ?int $userPostNewsId;
    public ?int $userApprovedPostNewsId;
    ...
    public ?CategoryNDetailDto $danhMucTinTuc;

    public ?UserDetailDto $nguoiTao;
    public ?UserDetailDto $nguoiApproved;
    ...
    public function __construct(?int $id = null, ?string $title = null, ?string $titleSlug = null
        ...
        , ?string $approvedDate = null, ?string $publishedDate = null, ?bool $isHotNews = null, ?int $countViews = null, ?bool $isApproved = null
        , ?int $userPostNewsId = null, ?int $userApprovedPostNewsId = null
        ...
        , ?CategoryNDetailDto $danhMucTinTuc = null, ?UserDetailDto $nguoiTao = null, ?UserDetailDto $nguoiApproved = null
    ...
    )
    {
        ...
        $this->userPostNewsId = $userPostNewsId;
        $this->userApprovedPostNewsId = $userApprovedPostNewsId;
        ...
        $this->nguoiApproved = $nguoiApproved;
    ...
    public static function createEmpty() : NewsDetailDto {
    ...
    public function jsonSerialize(): mixed {
        return [
            'ID' => $this->id,
            'TIEU_DE_TIN_TUC' => $this->title,
            'TIEU_DE_TIN_TUC_SLUG' => $this->titleSlug,
            'TOM_TAT_TIN_TUC' => $this->summary,
            'NOI_DUNG_TIN_TUC' => $this->contentFormat,
            'NOI_DUNG_TIN_TUC_ONLY_TEXT' => $this->contentOnlyText,
            'META_SEO_KEYWORDS' => $this->metaSeoKeywords,
            'META_SEO_DESCRIPTION' => $this->metaSeoDescription,
            'NGAY_APPROVED' => $this->approvedDate,
            'NGAY_XUAT_BAN' => $this->publishedDate,
            'TIN_TUC_NOI_BAT' => $this->isHotNews,
            'SO_LUOT_XEM' => $this->countViews,
            'TRANG_THAI_XUAT_BAN' => $this->isApproved,
            'USER_POST_NEWS_ID' => $this->userPostNewsId,
            'USER_APPROVED_POST_NEWS_ID' => $this->userApprovedPostNewsId,
            ...
            'DANH_MUC_TIN_TUC' => $this->danhMucTinTuc,
            'NGUOI_TAO' => $this->nguoiTao,
            'NGUOI_APPROVED' => $this->nguoiApproved,

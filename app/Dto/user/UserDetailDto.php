...
class UserDetailDto implements \JsonSerializable
{
    public ?int $id;
    public ?string $email;
    ...
    public ?DocumentStorageDetailDto $hinhAnhDaiDien;
    public ?string $urlFacebook;
    public ?string $urlZalo;
    public ?string $urlMessenger;

    public ?Collection $permissions;
    public ?TitleDetailDto $title;
     ...
     */
    public function __construct(?int $id = null, ?string $email = null, ?string $userName = null, ?string $fullName = null
        , ?string $address = null, ?string $mobile = null, ?DocumentStorageDetailDto $hinhAnhDaiDien = null, ?string $urlFacebook = null, ?string $urlZalo = null, ?string $urlMessenger = null
        , ?Collection $permissions = null
        , ?TitleDetailDto $title = null
        , ?string $roleId = null, ?string $roleCode = null, ?string $roleName = null
    ...
    )
    {
        ...
        $this->urlZalo = $urlZalo;
        $this->urlMessenger = $urlMessenger;
    ...
    public static function createEmpty() : UserDetailDto {
        return new self();
    }
    ...
    public function jsonSerialize(): mixed {
        return [
            ...
            , 'SO_DIEN_THOAI' => $this->mobile
            , 'HINH_ANH_DAI_DIEN' => $this->hinhAnhDaiDien
            , 'DUONG_DAN_FACEBOOK' => $this->urlFacebook
            , 'DUONG_DAN_ZALO' => $this->urlZalo
            , 'DUONG_DAN_MESSENGER' => $this->urlMessenger

            , 'PERMISSIONS' => $this->permissions
            , 'CHUC_DANH' => $this->title
            , 'VAI_TRO_ID' => $this->roleId
            , 'VAI_TRO_CODE' => $this->roleCode
            , 'VAI_TRO_NAME' => $this->roleName

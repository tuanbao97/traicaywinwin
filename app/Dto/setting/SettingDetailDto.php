...
class SettingDetailDto implements JsonSerializable
{
    public ?string $code;
    public ?string $name;
     ...
     */
    public function __construct(?string $code = null, ?string $name = null, ?string $nameSlug = null, ?string $value = null, ?string $unit = null, ?string $description = null
        , ?array $danhSachHinhAnh = null
    ...
    public static function createEmpty() : SettingDetailDto {
        return new self();
    }

...
class CategoryNRepositoyImpl extends BaseRepository implements CategoryNRepository
{
    public function getModel()
    {
        return CategoryN::class;
    }
    ...
    public function getListDanhMucTinTucWithChilds(?bool $isApiPublic, int $page, int $perPage)  : LengthAwarePaginator
    {
        ...
        $result->withPath('/categoryn/list/tree');

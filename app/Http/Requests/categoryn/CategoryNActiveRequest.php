...
class CategoryNActiveRequest extends FormRequest
{
    /**
    ...
    protected function failedValidation(\Illuminate\Contracts\Validation\Validator $validator)
    {
            ...
            foreach ($validator->failed() as $index => $validatorFailed) {
                if ('ID' === $index) {
                    ...
                    if ($idFailedRuleNotFound->isNotEmpty()) {
                        throw new NotFoundException($validator->errors(), 'Danh mục tin tức không tồn tại.');
                    }
                }
            }
        }
        ...
        throw new BadRequestException($validator->errors(), 'Kích hoạt thất bại.');
    }

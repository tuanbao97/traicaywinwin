...
class CategoryNDeleteRequest extends FormRequest
{
    /**
    ...
    public function authorize(): bool
    {
        ...
        foreach ($permissions as $index => $permission) {
            if ($permission->CODE === PermissionEnum::QL_DANH_MUC_TIN_TUC_XOA->value) {
                return true;
            }
        }
        return false;
    ...
    protected function failedValidation(\Illuminate\Contracts\Validation\Validator $validator)
    {
        ...
        throw new BadRequestException($validator->errors(), 'Xóa thất bại.');
    }
}

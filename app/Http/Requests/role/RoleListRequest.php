...
class RoleListRequest extends FormRequest
{
    ...
    public function messages()
    {
        ...
        $messagesForThisRequest = json_decode(file_get_contents(resource_path("lang/{$locale}/role/validation.json")), true);
    ...
    {
        $locale = app()->getLocale();
        $attributes = json_decode(file_get_contents(resource_path("lang/{$locale}/role/attributes.json")), true);

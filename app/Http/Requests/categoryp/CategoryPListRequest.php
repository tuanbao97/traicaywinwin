...
class CategoryPListRequest extends FormRequest
{
    ...
    public function authorize(): bool
    {
        ...
        foreach ($permissions as $index => $permission) {
            if ($permission->CODE === PermissionEnum::QL_DANH_MUC_SAN_PHAM_DANH_SACH->value) {
                return true;
            }
        }
        return false;
    ...
    public function rules(): array
    {
        ...
        if (!is_null($parentId)) {
            $rules['PARENT_ID'][] = new CheckNotExistsFieldRule('category_p', 'ID', $parentId, 'USING');
        }

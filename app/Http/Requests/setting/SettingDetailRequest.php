...
class SettingDetailRequest extends FormRequest
{
    ...
    public function authorize(): bool
    {
        ...
        foreach ($permissions as $index => $permission) {
            if ($permission->CODE === PermissionEnum::QL_CAI_DAT_CHI_TIET->value) {
                return true;
            }
        }
        return false;
    ...
    public function rules(): array
    {
        ...
        // Check tồn tại CODE
        $rules['CODE'][] = new CheckNotExistsFieldRule('setting', 'CODE', $this->CODE, 'USING');
    ...
    protected function failedValidation(\Illuminate\Contracts\Validation\Validator $validator)
    {
        ...
        if (!empty($idFailedRules)) {
            ...
            if ($idFailedRuleNotFound->isNotEmpty()) {
                throw new NotFoundException($validator->errors(), 'Cài đặt không tồn tại.');
            }
        }

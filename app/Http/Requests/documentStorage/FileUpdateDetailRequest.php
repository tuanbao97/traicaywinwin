...
class FileUpdateDetailRequest extends FormRequest
{
    ...
    public function messages()
    {
        ...
        $messagesForThisRequest = json_decode(file_get_contents(resource_path("lang/{$locale}/documentStorage/file-dinh-kem/validation.json")), true);
    ...
    {
        $locale = app()->getLocale();
        $attributes = json_decode(file_get_contents(resource_path("lang/{$locale}/documentStorage/file-dinh-kem/attributes.json")), true);

			...
			return w.prototype.generateSettings = function(e) {
				...
				if (!(this.$container && this.$container.get())) {
					...
					var n = this.settings.ariaLabelledby ? 'aria-labelledby="' + this.settings.ariaLabelledby + '"' : "",
						...
						l = this.settings.closable && this.settings.showCloseIcon ? '<button type="button" aria-label="' + this.settings.strings.closeGallery + '" id="' + this.getIdName("lg-close") + '" class="lg-close lg-icon" style="color: #f37e7e;"></button>' : "",

...
!function(t, e) {
    if ("function" == typeof define && define.amd)
        ...
        e(n.exports, t.jQuery, t.AsColor),
        t.AsGradient = n.exports
    }
}(this, function(t, e, n) {
    "use strict";
    function r(t) {
    ...
    function i() {
        var t = window.navigator.userAgent
          , e = "";
        return /MSIE/g.test(t) ? e = "-ms-" : /Firefox/g.test(t) ? e = "-moz-" : /(WebKit)/i.test(t) ? e = "-webkit-" : /Opera/g.test(t) && (e = "-o-"),
        e
    }
    function s(t) {
        var e = {
    ...
    var c = {
      ...
      , d = {
        ...
        formatStops: function(t, e) {
            for (var n = void 0, r = [], o = [], i = [], s = void 0, a = 0; a < t.length; a++)
                s = void 0 === (n = t[a]).position || null === n.position ? 0 === a ? 0 : a === t.length - 1 ? 1 : void 0 : n.position,
                o.push(s),
            ...
            for (var u = 0; u < t.length; u++)
                s = e && (0 === u && 0 === o[u] || u === t.length - 1 && 1 === o[u]) ? "" : " " + this.formatPosition(o[u]),
                r.push(i[u] + s);
            return r.join(", ")
        },
        ...
        parsePosition: function(t) {
            return "string" == typeof t && "%" === t.substr(-1) && (t = parseFloat(t.slice(0, -1) / 100)),
        ...
        parseAngle: function(t, e) {
            if ("string" == typeof t && t.includes("deg") && (t = t.replace("deg", "")),
            ...
            return u > 360 ? u %= 360 : u < 0 && 0 !== (u %= -360) && (u += 360),
            u
        },
        ...
        formatAngle: function(t, e, n) {
            ...
            n && v.hasOwnProperty(t) ? (t = v[t],
            e && (t = s(t.substr(3)))) : (e && (t = this.fixOldAngle(t)),
            t += "deg"),
            t
        }
    }
      , y = function() {
        ...
        return f(t, [{
            ...
            value: function(t) {
                ...
                this.position !== e && (this.position = e,
      ...
      , b = function() {
        function t(e, n) {
            o(this, t),
            "object" === (void 0 === e ? "undefined" : p(e)) && void 0 === n && (n = e,
            e = void 0),
            this.value = {
                angle: 0,
                stops: []
        ...
        return f(t, [{
            ...
            key: "val",
            value: function(t) {
                return void 0 === t ? this.toString() : (this.fromString(t),
                this)
            }
        }, {
            key: "angle",
            value: function(t) {
                return void 0 === t ? this.value.angle : (this.value.angle = d.parseAngle(t),
                this)
            }
        }, {
            key: "append",
            ...
            value: function(t, e, n) {
                ...
                return this.value.stops.splice(n, 0, r),
            ...
            value: function(t) {
                ...
                t >= 0 && t < this.length && (this.current = t,
                this.value.stops[t])
            }
        }, {
            key: "remove",
            value: function(t) {
                ...
                t >= 0 && t < this.length && (this.value.stops.splice(t, 1),
                this.length = this.length - 1,
                this.current = t - 1)
            }
        }, {
            ...
            key: "type",
            value: function(t) {
                return "string" == typeof t && (t = t.toUpperCase()) && void 0 !== m[t] ? (this._type = t,
                this) : this._type
            }
        }, {
            key: "fromString",
            value: function(t) {
                ...
                n && (this._prefix = n.prefix,
                this.type(n.type),
                n.value && (this.value.angle = d.parseAngle(n.value.angle, null !== this._prefix),
    ...
    u.default.extend(u.default.asGradient, {
        setDefaults: b.setDefaults,
        noConflict: function() {
            return u.default.asGradient = x,
            k
        }
    }, d, S);

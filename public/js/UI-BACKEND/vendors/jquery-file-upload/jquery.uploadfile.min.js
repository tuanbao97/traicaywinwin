    ...
    e.fn.uploadFile = function(t) {
        ...
        function c(a, t) {
            if (a.showFileCounter) {
                ...
                t.fileCounter = r + 1,
                e(t.container).find(".ajax-file-upload-filename").each(function() {
                    var t = e(this).html().split(a.fileCounterStyle)
                      , o = (parseInt(t[0]) - 1,
                    r + a.fileCounterStyle + t[1]);
                    e(this).html(o),
                    r--
                })
            }
        ...
        function h(t, r, o, s) {
            ...
            d.appendTo(s)) : (d.appendTo(e("body")),
            d.css({
                margin: 0,
                padding: 0,
                display: "block",
        ...
        function F() {
            if (e.fn.ajaxForm) {
                ...
                C.container = w.showQueueDiv ? e("#" + w.showQueueDiv) : e("<div class='ajax-file-upload-container'></div>").insertAfter(e(C)),
        ...
        this.createProgress = function(e, a, t) {
            ...
            C.fileCounter++,
            C.selectedFiles++,
            w.showPreview && (r.preview.attr("src", a),
            r.preview.show()),

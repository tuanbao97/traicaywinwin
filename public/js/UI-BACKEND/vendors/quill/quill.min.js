...
!function(t, e) {
    ...
    , function(t, e, n) {
        ...
        ["selectionchange", "mousedown", "mouseup"].forEach(function(t) {
          ...
          , x = function() {
            function t(e, n) {
                ...
                this.root.addEventListener("compositionend", function() {
                    if (r.composing = !1,
                    r.cursor.parent) {
                        var t = r.cursor.restore();
                        if (!t)
                            return;
                        setTimeout(function() {
                            r.setNativeRange(t.startNode, t.startOffset, t.endNode, t.endOffset)
                        }, 1)
                    }
                }),
                this.cursor = c.default.create("cursor", this),
                this.lastRange = this.savedRange = new w(0,0),
                this.root.addEventListener("click", function(t) {
                    var n = c.default.find(t.target, !0)
                      , o = document.querySelector(".ql-embed-selected");
                    if (o && o.classList.remove("ql-embed-selected"),
                    n instanceof c.default.Embed) {
                        n.domNode.classList.add("ql-embed-selected");
                        var i = new w(n.offset(e),n.length());
                        r.setRange(i, g.default.sources.USER),
                        t.stopPropagation()
                    }
                });
                var o = 0;
                ...
                this.emitter.listenDOM("mouseup", document.body, function() {
                    0 === (o -= 1) && r.update(g.default.sources.USER)
                }),
                this.emitter.listenDOM("selectionchange", document, function() {
                    0 === o && setTimeout(r.update.bind(r, g.default.sources.USER), 1)
                }),
                this.emitter.on(g.default.events.EDITOR_CHANGE, function(t, e) {
                    t === g.default.events.TEXT_CHANGE && e.length() > 0 && r.update(g.default.sources.SILENT)
                }),
                this.emitter.on(g.default.events.SCROLL_BEFORE_UPDATE, function() {
                    if (r.hasFocus()) {
                        var t = r.getNativeRange();
                        null != t && t.start.node !== r.cursor.textNode && r.emitter.once(g.default.events.SCROLL_UPDATE, function() {
                            try {
                ...
                this.emitter.on(g.default.events.SCROLL_OPTIMIZE, function(t, e) {
                    if (e.range) {
                        var n = e.range
                          , o = n.startNode
                          , i = n.startOffset
            ...
            return s(t, [{
                ...
                value: function(t) {
                    if (null != t) {
                        var e = [t.start, t.end].map(function(t) {
                            var e = c.default.find(t.node, !0);
                            if (e instanceof h.default) {
                                var n = void 0
                                  , r = void 0;
                                if (t.node === e.leftGuard && 1 === t.offset) {
                                    var o = e.position(e.length())
                                      , i = a(o, 2);
                                    return n = i[0],
                                    r = i[1],
                                    {
                                ...
                                if (t.node === e.rightGuard && 0 === t.offset) {
                                    var l = e.position(0)
                                      , s = a(l, 2);
                                    return n = s[0],
                                    r = s[1],
                          ...
                          , r = n[0]
                          , o = n[1];
                        t.start === r && t.end === o || this.setNativeRange(r.node, r.offset, o.node, o.offset)
                    }
                }
            }, {
                key: "focus",
                ...
                value: function() {
                    ...
                    return O.info("getNativeRange", n),
                    n
                }
            }, {
                key: "getRange",
                ...
                value: function(t, e) {
                    ...
                    if (O.info("setNativeRange", t, e, n, r),
                ...
                value: function() {
                    var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : g.default.sources.USER
                      ...
                      , o = r[0]
                      , i = r[1];
                    if (this.fixInlineEmbed(i),
                    this.lastRange = o,
                    null != this.lastRange && (this.savedRange = this.lastRange),
                    !(0,
                    v.default)(e, this.lastRange)) {
                        var l;
                        !this.composing && null != i && i.native.collapsed && i.start.node !== this.cursor.textNode && this.cursor.restore();
                        var s = [g.default.events.SELECTION_CHANGE, (0,
                        d.default)(this.lastRange), (0,
                        d.default)(e), t];
                        if ((l = this.emitter).emit.apply(l, [g.default.events.EDITOR_CHANGE].concat(s)),
                        t !== g.default.sources.SILENT) {
                            var u;
        ...
        var a = function() {
          ...
          , d = function(t) {
            function e(t) {
                ...
                return r.setAttribute("contenteditable", !1),
    ...
    , function(t, e, n) {
        ...
        function a(t, e) {
            if (!(0 === t.index || this.quill.getLength() <= 1)) {
                ...
                this.quill.deleteText(t.index - f, f, T.default.sources.USER),
                Object.keys(i).length > 0 && this.quill.formatLine(t.index - f, f, i, T.default.sources.USER),
                this.quill.focus()
            }
        }
        function s(t, e) {
            ...
            if (!(t.index >= this.quill.getLength() - n)) {
                ...
                if (e.offset >= a.length() - 1) {
                    ...
                    if (c) {
                        ...
                        r = N.default.attributes.diff(f, h) || {},
                        o = c.length()
                    }
                }
                this.quill.deleteText(t.index, n, T.default.sources.USER),
                Object.keys(r).length > 0 && this.quill.formatLine(t.index + o - 1, n, r, T.default.sources.USER)
            }
        }
        function u(t) {
            ...
            this.quill.deleteText(t, T.default.sources.USER),
            Object.keys(n).length > 0 && this.quill.formatLine(t.index, 1, n, T.default.sources.USER),
            this.quill.setSelection(t.index, T.default.sources.SILENT),
            this.quill.focus()
        }
        function c(t, e) {
            var n = this;
            ...
            var r = Object.keys(e.format).reduce(function(t, n) {
                return A.default.query(n, A.default.Scope.BLOCK) && !Array.isArray(e.format[n]) && (t[n] = e.format[n]),
                t
            }, {});
            this.quill.insertText(t.index, "\n", r, T.default.sources.USER),
            this.quill.setSelection(t.index + 1, T.default.sources.SILENT),
            this.quill.focus(),
            Object.keys(e.format).forEach(function(t) {
                null == r[t] && (Array.isArray(e.format[t]) || "link" !== t && n.quill.format(t, e.format[t], T.default.sources.USER))
            })
        }
        function f(t) {
            return {
                ...
                handler: function(e) {
                    ...
                    if (null != a) {
                        ...
                        this.quill.update(T.default.sources.USER),
                        this.quill.setSelection(r, o, T.default.sources.SILENT)
                    }
                }
            }
        }
        function h(t) {
            return {
                ...
                handler: function(e, n) {
                    this.quill.format(t, !n.format[t], T.default.sources.USER)
                }
            }
        }
        function p(t) {
            ...
            if ("object" === (void 0 === t ? "undefined" : d(t)) && (t = (0,
            g.default)(t, !1)),
            "string" == typeof t.key)
                if (null != I.keys[t.key.toUpperCase()])
                    t.key = I.keys[t.key.toUpperCase()];
                else {
                    if (1 !== t.key.length)
                        return null;
                    t.key = t.key.toUpperCase().charCodeAt(0)
                }
            return t.shortKey && (t[R] = t.shortKey,
            delete t.shortKey),
            t
        }
        Object.defineProperty(e, "__esModule", {
            ...
            v(e, [{
                ...
                value: function(t) {
                    ...
                    if (null == r || null == r.key)
                        return M.warn("Attempted to add invalid keyboard binding", r);
                    "function" == typeof e && (e = {
                        handler: e
                    }),
                    "function" == typeof n && (n = {
                            ...
                            if (0 !== o.length) {
                                ...
                                if (null != i && t.quill.hasFocus()) {
                                    var l = t.quill.getLine(i.index)
                                      ...
                                      , h = f[0]
                                      , p = f[1]
                                      , v = 0 === i.length ? [h, p] : t.quill.getLeaf(i.index + i.length)
                                      , b = y(v, 2)
                                      , g = b[0]
                                      , m = b[1]
                                      , O = h instanceof A.default.Text ? h.value().slice(0, p) : ""
        ...
        I.DEFAULTS = {
            bindings: {
                ...
                indent: {
                    ...
                    handler: function(t, e) {
                        if (e.collapsed && 0 !== e.offset)
                            return !0;
                        this.quill.format("indent", "+1", T.default.sources.USER)
                    }
                },
                outdent: {
                    key: I.keys.TAB,
                ...
                "outdent backspace": {
                    ...
                    offset: 0,
                    handler: function(t, e) {
                        null != e.format.indent ? this.quill.format("indent", "-1", T.default.sources.USER) : null != e.format.list && this.quill.format("list", !1, T.default.sources.USER)
                    }
                },
                ...
                "remove tab": {
                    ...
                    prefix: /\t$/,
                    handler: function(t) {
                        this.quill.deleteText(t.index - 1, 1, T.default.sources.USER)
                    }
                },
                tab: {
                    key: I.keys.TAB,
                    handler: function(t) {
                        ...
                        var e = (new k.default).retain(t.index).delete(t.length).insert("\t");
                        this.quill.updateContents(e, T.default.sources.USER),
                        this.quill.history.cutoff(),
                        this.quill.setSelection(t.index + 1, T.default.sources.SILENT)
                    }
                },
                "list empty enter": {
                    ...
                    handler: function(t, e) {
                        ...
                        e.format.indent && this.quill.format("indent", !1, T.default.sources.USER)
                    }
                },
                "checklist enter": {
                    key: I.keys.ENTER,
                    ...
                    handler: function(t) {
                        var e = this.quill.getLine(t.index)
                          ...
                          , r = n[0]
                          , o = n[1]
                          , i = (new k.default).retain(t.index).insert("\n", {
                            list: "checked"
                        }).retain(r.length() - o - 1).retain(1, {
                            list: "unchecked"
                        });
                        this.quill.updateContents(i, T.default.sources.USER),
                        this.quill.setSelection(t.index + 1, T.default.sources.SILENT),
                ...
                "header enter": {
                    ...
                    handler: function(t, e) {
                        var n = this.quill.getLine(t.index)
                          ...
                          , o = r[0]
                          , i = r[1]
                          , l = (new k.default).retain(t.index).insert("\n", e.format).retain(o.length() - i - 1).retain(1, {
                            header: null
                        });
                ...
                "list autofill": {
                    ...
                    handler: function(t, e) {
                        ...
                        this.quill.insertText(t.index, " ", T.default.sources.USER),
                        this.quill.history.cutoff();
                        var o = this.quill.getLine(t.index + 1)
                          , i = y(o, 2)
                          , l = i[0]
                          , a = i[1]
                          , s = (new k.default).retain(t.index + 1 - a).delete(n + 1).retain(l.length() - 1 - a).retain(1, {
                            list: r
                        });
                        this.quill.updateContents(s, T.default.sources.USER),
                        this.quill.history.cutoff(),
                        this.quill.setSelection(t.index - n, T.default.sources.SILENT)
                    }
                },
                "code exit": {
                    key: I.keys.ENTER,
                    ...
                    suffix: /^\s+$/,
                    handler: function(t) {
                        this.quill.format("code-block", !1, T.default.sources.USER),
                        this.quill.deleteText(t.index - 2, 1, T.default.sources.USER)
                    }
                }
            }
        },
    ...
    , function(t, e) {
        ...
        function r(t, e) {
            ...
            if (-1 != a)
                ...
                t.length > e.length && (r[0][0] = r[2][0] = p),
                r;
            if (1 == l.length)
                return [[p, t], [d, e]];
            var u = s(t, e);
        ...
        function o(t, e) {
            ...
            s[l + 1] = 0,
            u[l + 1] = 0;
            for (var f = n - r, h = f % 2 != 0, y = 0, v = 0, b = 0, g = 0, m = 0; m < o; m++) {
        ...
        function u(t) {
            ...
            for (var e, n = 0, r = 0, o = 0, i = "", s = ""; n < t.length; )
                ...
                case y:
                    ...
                    0 === r ? t.splice(n - o, r + o, [d, s]) : 0 === o ? t.splice(n - r, r + o, [p, i]) : t.splice(n - r - o, r + o, [p, i], [d, s]),
    ...
    , function(t, e, n) {
        ...
        function d(t, e) {
            ...
            return n.concat(r).concat(o).forEach(function(e) {
                ...
                i[n.attrName]) || (n = V[e],
                null != n && n.attrName === e && (i[n.attrName] = n.value(t) || void 0),
                null != (n = G[e]) && n.attrName === e && (n = G[e],
        ...
        M.default)("quill:clipboard")
          , Z = "__ql-matcher"
          , W = [[Node.TEXT_NODE, w], [Node.TEXT_NODE, m], ["br", v], [Node.ELEMENT_NODE, m], [Node.ELEMENT_NODE, y], [Node.ELEMENT_NODE, _], [Node.ELEMENT_NODE, d], [Node.ELEMENT_NODE, O], ["li", g], ["b", p.bind(p, "bold")], ["i", p.bind(p, "italic")], ["style", b]]
          , V = [B.AlignAttribute, F.DirectionAttribute].reduce(function(t, e) {
            return t[e.keyName] = e,
            t
        }, {})
          , G = [B.AlignStyle, D.BackgroundStyle, U.ColorStyle, F.DirectionStyle, H.FontStyle, K.SizeStyle].reduce(function(t, e) {
            return t[e.keyName] = e,
            t
        }, {})
          , Y = function(t) {
            function e(t, n) {
                ...
                r.matchers = [],
                W.concat(r.options.matchers).forEach(function(t) {
                    var e = k(t, 2)
                      , o = e[0]
                      , i = e[1];
            ...
            E(e, [{
                ...
                value: function(t) {
                    ...
                    var e = this.prepareMatching()
                      , n = k(e, 2)
                      , r = n[0]
                      , o = n[1]
                      , i = h(this.container, r, o);
                    return c(i, "\n") && null == i.ops[i.ops.length - 1].attributes && (i = i.compose((new q.default).retain(i.length() - 1).delete(1))),
                    z.log("convert", this.container.innerHTML, i),
                    this.container.innerHTML = "",
                    i
                }
            }, {
                ...
                value: function(t, e) {
                    ...
                    return this.quill.updateContents((new q.default).retain(t).concat(r), n)
                }
            }, {
                key: "onPaste",
                value: function(t) {

!function(a) {
    ...
    a.fn.removeTag = function(d) {
        ...
        this.each(function() {
            ...
            for (a("#" + e + "_tagsinput .tag").remove(),
            str = "",
            i = 0; i < f.length; i++)
                f[i] != d && (str = str + b[e] + f[i]);
            if (a.fn.tagsInput.importTags(this, str),
            c[e] && c[e].onRemoveTag) {
    ...
    a.fn.tagsInput = function(e) {
        ...
        return this.each(function() {
            if ("undefined" == typeof a(this).attr("data-tagsinput-init")) {
                ...
                b[e] = h.delimiter,
                (f.onAddTag || f.onRemoveTag || f.onChange) && (c[e] = new Array,
                ...
                if (f.interactive && (i = i + '<input id="' + e + '_tag" value="" data-default="' + f.defaultText + '" />'),
                ...
                f.interactive) {
                    if (a(h.fake_input).val(a(h.fake_input).attr("data-default")),
                    ...
                    void 0 != f.autocomplete_url) {
                        ...
                        void 0 !== jQuery.Autocompleter ? (a(h.fake_input).autocomplete(f.autocomplete_url, f.autocomplete),
                        a(h.fake_input).bind("result", h, function(b, c, d) {
                            c && a("#" + e).addTag(c[0] + "", {
                                focus: !0,
                                unique: f.unique
                            })
                        })) : void 0 !== jQuery.ui.autocomplete && (a(h.fake_input).autocomplete(autocomplete_options),
                    ...
                    a(h.fake_input).bind("keypress", h, function(b) {
                        ...
                        !1) : void (b.data.autosize && a(b.data.fake_input).doAutosize(f))
                    }),

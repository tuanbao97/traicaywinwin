...
return new class extends Migration
{
    ...
    {
        Schema::create('category_p', function (Blueprint $table) {
            $table->comment('Bảng loại sản phẩm');
            $table->bigInteger('ID', true)->comment('id');
            $table->string('NAME', 1000)->comment('Tên loại sản phẩm');
    ...
    {
        Schema::dropIfExists('category_p');
    }
};

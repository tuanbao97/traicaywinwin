...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('title', function (Blueprint $table) {
            $table->comment('Bảng chức danh');
            $table->bigInteger('ID', true)->comment('Mã chức danh');
            $table->bigInteger('USER_ID')->index('title_fk')->comment('Mã người dùng');
            $table->bigInteger('ROLE_ID')->index('title_fk_1')->comment('Mã vai trò');

...
return new class extends Migration
{
    ...
    {
        Schema::create('news_document_storage', function (Blueprint $table) {
            $table->comment('Bảng tin tức - file upload');
            $table->bigInteger('ID', true)->comment('id');
            $table->bigInteger('NEWS_ID')->index('news_document_storage_fk')->comment('Tin tức id');
            $table->bigInteger('DOCUMENT_STORAGE_ID')->index('news_document_storage_fk_1')->comment('File id');
    ...
    {
        Schema::dropIfExists('news_document_storage');
    }
};

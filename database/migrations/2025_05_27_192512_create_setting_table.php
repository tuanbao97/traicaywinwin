...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('setting', function (Blueprint $table) {
            $table->comment('Bảng cài đặt chung của hệ thống');
            $table->string('CODE', 191)->primary()->comment('Mã');
            $table->string('NAME', 2000)->comment('Tên');
            $table->string('TYPE')->nullable();
            $table->longText('VALUE')->nullable()->comment('Giá trị');
            $table->string('UNIT', 500)->nullable()->comment('Đơn vị');

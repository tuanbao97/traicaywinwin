...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('product_category', function (Blueprint $table) {
            $table->comment('Bảng sản phẩm - loại sản phẩm');
            $table->bigInteger('ID', true)->comment('id');
            $table->bigInteger('PRODUCT_ID')->index('product_category_fk')->comment('Sản phẩm id');
            $table->bigInteger('CATEGORY_ID')->index('product_category_fk_1')->comment('Loại sản phẩm id');

...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('role_permission', function (Blueprint $table) {
            $table->comment('Bảng role_permission');
            $table->bigInteger('ROLE_ID')->comment('Vai trò id');
            $table->string('PERMISSION_CODE', 191)->index('role_permission_fk_1')->comment('Mã quyền');

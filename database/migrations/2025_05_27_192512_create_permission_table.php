...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('permission', function (Blueprint $table) {
            $table->comment('Bảng quyền');
            $table->string('CODE', 191)->primary()->comment('Mã quyền');
            $table->string('NAME', 1000)->comment('Tên mã quyền');
            $table->string('PARENT_CODE', 191)->nullable()->comment('Mã quyền cha');

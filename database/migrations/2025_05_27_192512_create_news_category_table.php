...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('news_category', function (Blueprint $table) {
            $table->comment('Bảng tin tức - thể loại');
            $table->bigInteger('ID', true)->comment('id');
            $table->bigInteger('NEWS_ID')->index('news_category_fk')->comment('Tin tức id');
            $table->bigInteger('CATEGORY_ID')->index('news_category_fk_1')->comment('Thể loại tin tức id');

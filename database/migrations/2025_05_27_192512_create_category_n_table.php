...
return new class extends Migration
{
    ...
    {
        Schema::create('category_n', function (Blueprint $table) {
            $table->comment('Bảng thể loại tin tức');
            $table->bigInteger('ID', true)->comment('id');
            $table->string('NAME', 1000)->comment('Tên thể loại tin tức');
            ...
            $table->integer('TREE_LEVEL')->nullable()->comment('Level tree');
    ...
    {
        Schema::dropIfExists('category_n');
    }
};

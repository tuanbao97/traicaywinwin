...
<body class="ega-theme search">@include('UI-FRONTEND.common.header')
    ...
    <section class="section section-main-search" style="--section-margin: 0px 0px 40px; --section-margin-mb: 0px 0px 20px">
      <div class="container">
        ...
        <div class="ww-search-layout">
          ...
          <div id="search-results-grid" class="product-list grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-5 gap-2">
            @if ($total === 0)
        ...
        @else
        <div id="search-results-grid" class="product-list grid grid-cols-2 md:grid-cols-5 lg:grid-cols-5 gap-2">
  ...
  <script src="100/531/894/themes/1018832/assets/main.js?ww-search-1" defer fetchpriority="low"></script>
  <script src="100/531/894/themes/1018832/assets/defer-scripts.js?ww-search-sticky-1" defer fetchpriority="low"></script>

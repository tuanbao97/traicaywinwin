...
$(document).ready(function(){
    ...
    function initSelect2TreeDanhMucSanPham(arrayData, isDefaultGetAll, selectedVal) {
	...
	getListDanhMucSanPhamTree = function(selectedVal) {
		...
		$.ajax({
			...
			success : function(data, textStatus, request) {
				...
				// Init select2 tree
				initSelect2TreeDanhMucSanPham(arrResult, {{ $isDefaultGetAll }}, selectedVal || null);

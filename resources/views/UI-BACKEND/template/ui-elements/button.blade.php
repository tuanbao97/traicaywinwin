								...
								<div class="card-body">
									...
									<div class="template-demo">
										<button type="button" class="btn btn-info btn-lg btn-block">
											Block buttons <i class="typcn typcn-th-menu float-right"></i>
										</button>
										<button type="button" class="btn btn-dark btn-lg btn-block">Block
											buttons</button>
										<button type="button" class="btn btn-primary btn-lg btn-block">
											<i class="typcn typcn-user"></i> Block buttons
										</button>
										<button type="button"
											class="btn btn-outline-secondary btn-lg btn-block">Block
											buttons</button>
									</div>
								</div>
							</div>
												...
												<div class="btn-group-vertical" role="group"
													...
													<div class="btn-group">
														...
														<div class="dropdown-menu">
															<a class="dropdown-item">Go back</a> <a
																class="dropdown-item">Delete</a> <a
																class="dropdown-item">Swap</a>
														</div>
													</div>
													<button type="button" class="btn btn-outline-secondary">Default</button>
												</div>
									...
									<div class="col-md-6">
										<div class="card-body">
											...
											<p class="card-description">
												...
												<code>.btn-icon-text</code>
												and use
												<code>.btn-icon-prepend</code>
												or
												<code>.btn-icon-append</code>
												for icon tags
											</p>
											<div class="template-demo">
												...
												<button type="button" class="btn btn-dark btn-icon-text">
													Edit <i class="typcn typcn-document btn-icon-append"></i>
												</button>
											...
											<div class="template-demo">
												<button type="button" class="btn btn-danger btn-icon-text">
													<i class="typcn typcn-upload btn-icon-prepend"></i> Upload
												</button>
												<button type="button" class="btn btn-info btn-icon-text">
													Print <i class="typcn typcn-printer btn-icon-append"></i>
												</button>
											...
											<div class="template-demo mt-2">
												<button class="btn btn-outline-dark btn-icon-text">
													<i class="typcn typcn-vendor-apple btn-icon-prepend"></i> <span
														class="d-inline-block text-start"> <small
														class="font-weight-light d-block">Available on the</small>
														App Store
													</span>
												</button>
												<button class="btn btn-outline-dark btn-icon-text">
													<i class="typcn typcn-vendor-android btn-icon-prepend"></i>
													<span class="d-inline-block text-start"> <small
														class="font-weight-light d-block">Get it on the</small>
														Google Play
													</span>
												</button>
											</div>
								...
								<div class="card-body">
									...
									<div class="template-demo">
										...
										<button type="button"
											...
											<i class="typcn typcn-social-dribbble"></i>
										</button>
										<button type="button"
								...
								<div class="card-body">
									...
									<div class="template-demo">
										<button type="button"
											...
											<i class="typcn typcn-social-facebook"></i>Facebook
										</button>
										<button type="button"
											class="btn btn-social-icon-text btn-youtube">
											<i class="typcn typcn-social-youtube"></i>Youtube
										</button>
										<button type="button"
											class="btn btn-social-icon-text btn-twitter">
											<i class="typcn typcn-social-twitter"></i>Twitter
										</button>
										<button type="button"
											class="btn btn-social-icon-text btn-dribbble">
											<i class="typcn typcn-social-dribbble"></i>Dribbble
										</button>
										<button type="button"
											class="btn btn-social-icon-text btn-linkedin">
											<i class="typcn typcn-social-linkedin"></i>Linkedin
										</button>
										<button type="button"
											class="btn btn-social-icon-text btn-google">
											<i class="typcn typcn-social-google-plus"></i>Google
										</button>
									</div>
								</div>
							</div>

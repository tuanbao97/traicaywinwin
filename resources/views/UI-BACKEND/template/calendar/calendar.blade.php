...
<!-- plugin css for this page -->
 <link rel="stylesheet" href="{{ asset('css/UI-BACKEND/vendors/fullcalendar/fullcalendar.min.css') }}">
...
<body>
							...
							<div class="mt-4">
								...
								<div class="form-check form-check-primary">
									<label class="form-check-label"> <input type="checkbox"
										class="form-check-input" checked> Project Board
									</label>
								</div>
								<div class="form-check form-check-danger">
									<label class="form-check-label"> <input type="checkbox"
										class="form-check-input" checked> Kamban Board
									</label>
								</div>
								<div class="form-check form-check-info">
									<label class="form-check-label"> <input type="checkbox"
										class="form-check-input" checked> Summary Board
									</label>
								</div>
								<div class="form-check form-check-success">
									<label class="form-check-label"> <input type="checkbox"
										class="form-check-input" checked> Planner Board
									</label>
								</div>
							</div>
						</div>
	...
	<script src="{{ asset('js/UI-BACKEND/vendors/moment/moment.min.js') }}"></script>
  	<script src="{{ asset('js/UI-BACKEND/vendors/fullcalendar/fullcalendar.min.js') }}"></script>
	...
	<script src="{{ asset('js/UI-BACKEND/calendar.js') }}"></script>

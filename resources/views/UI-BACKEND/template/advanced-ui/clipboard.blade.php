...
<link rel="stylesheet"
	href="{{ asset('css/UI-BACKEND/vendors/dragula/dragula.min.css') }}">
...
<body>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="card-body">
											...
											<input type="text" id="clipboardExample1"
												class="form-control" value="hello">
											<div class="mt-3">
												<button type="button" class="btn btn-info btn-clipboard"
													data-clipboard-action="copy"
													data-clipboard-target="#clipboardExample1">Copy</button>
												<button type="button" class="btn btn-success btn-clipboard"
													data-clipboard-action="cut"
													data-clipboard-target="#clipboardExample1">Cut</button>
											</div>
										</div>
									</div>
									<div class="col-md-6">
										<div class="card-body">
											...
											<textarea id="clipboardExample2" class="form-control"
												rows="3">Hello</textarea>
											<div class="mt-3">
												<button type="button" class="btn btn-info btn-clipboard"
													data-clipboard-action="copy"
													data-clipboard-target="#clipboardExample2">Copy</button>
												<button type="button" class="btn btn-success btn-clipboard"
													data-clipboard-action="cut"
													data-clipboard-target="#clipboardExample2">Cut</button>
											</div>
										</div>
									</div>
								</div>
									...
									<div class="col-md-6">
										<div class="card-body">
											...
											<div class="card card-inverse-secondary">
												<div class="card-body">
													<p id="clipboardExample3">Lorem ipsum dolor sit amet,
											...
											<div class="mt-3">
												<button type="button" class="btn btn-info btn-clipboard"
													data-clipboard-action="copy"
													data-clipboard-target="#clipboardExample3">Copy</button>
											</div>
										</div>
									</div>
									<div class="col-md-6">
										<div class="card-body">
											...
											<p class="card-description">Copy the highlighted text from
												this paragraph</p>
											<div class="card card-inverse-secondary">
												<div class="card-body">
													<p>
														Lorem ipsum <span class="bg-info text-white"
															id="clipboardExample4">dolor sit amet</span>, consectetur
											...
											<div class="mt-3">
												<button type="button" class="btn btn-info btn-clipboard"
													data-clipboard-action="copy"
													data-clipboard-target="#clipboardExample4">Copy highlighted
													text</button>
											</div>
										</div>
									</div>
	...
	<script src="{{ asset('js/UI-BACKEND/vendors/clipboard/clipboard.min.js') }}"></script>
	...
	<script src="{{ asset('js/UI-BACKEND/clipboard.js') }}"></script>

...
<link rel="stylesheet" href="{{ asset('css/UI-BACKEND/vendors/jquery-contextmenu/jquery.contextMenu.min.css') }}">
...
<body>
							...
							<div class="card">
								<div class="card-body">
									...
									<div class="card card-inverse-info" id="context-menu-simple">
										<div class="card-body">
											<p class="card-text">Right click somewhere in this colored
												area for simple context menu</p>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="card">
								<div class="card-body">
									...
									<div class="card card-inverse-success" id="context-menu-access">
										<div class="card-body">
											<p class="card-text">Right click in this colored area for
												context menu with action</p>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="card">
								<div class="card-body">
									...
									<div class="card card-inverse-warning" id="context-menu-open">
										<div class="card-body">
											<p class="card-text">Right click somewhere in this colored
												area for context menu that keeps opened</p>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="card">
								<div class="card-body">
									...
									<div class="card card-inverse-danger" id="context-menu-multi">
										<div class="card-body">
											<p class="card-text">Right click somewhere in this colored
												area for context menu with multiple levels (sub menu)</p>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="col-md-6">
							<div class="card">
								<div class="card-body">
									...
									<p class="card-description">Context menu with hide/show on
										louse in/out</p>
									<div class="card card-inverse-primary"
										id="context-menu-hover-autohide">
										<div class="card-body">
											<p class="card-text">Hover here for context menu and mouse
												out for hiding</p>
										</div>
									</div>
								</div>
	...
	<script src="{{ asset('js/UI-BACKEND/vendors/jquery-contextmenu/jquery.contextMenu.min.js') }}"></script>
	...
	<script src="{{ asset('js/UI-BACKEND/context-menu.js') }}"></script>

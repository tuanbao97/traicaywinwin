...
<link rel="stylesheet" href="{{ asset('css/UI-BACKEND/vendors/owl-carousel-2/owl.carousel.min.css') }}">
<link rel="stylesheet" href="{{ asset('css/UI-BACKEND/vendors/owl-carousel-2/owl.theme.default.min.css') }}">
...
<body>
							...
							<div class="card">
								<div class="card-body">
									...
									<div class="owl-carousel owl-theme full-width">
										<div class="item">
											<img src="{{ asset('image/UI-BACKEND/carousel/banner_12.jpg') }}"
												alt="image" />
										</div>
										<div class="item">
											<img src="{{ asset('image/UI-BACKEND/carousel/banner_2.jpg') }}"
												alt="image" />
										</div>
										<div class="item">
											<img src="{{ asset('image/UI-BACKEND/carousel/banner_1.jpg') }}"
												alt="image" />
										</div>
									</div>
								</div>
									...
									<div class="owl-carousel owl-theme full-width">
										<div class="item">
											<div class="card text-white">
												<img class="card-img"
													src="{{ asset('image/UI-BACKEND/carousel/banner_5.jpg') }}"
													alt="Card image">
												<div class="card-img-overlay d-flex">
													<div class="mt-auto text-center w-100">
														<h3>Third Slide Label</h3>
														<h6 class="card-text mb-4 font-weight-normal">Nulla vitae
															elit libero, a pharetra augue mollis interdum.</h6>
													</div>
												</div>
											</div>
										</div>
										...
										<div class="item">
											<div class="card text-white">
												<img class="card-img"
													src="{{ asset('image/UI-BACKEND/carousel/banner_6.jpg') }}"
													alt="Card image">
												<div class="card-img-overlay d-flex">
													<div class="mt-auto text-center w-100">
														<h3>Third Slide Label</h3>
							...
							<div class="card">
								<div class="card-body">
									...
									<div class="owl-carousel owl-theme loop">
										<div class="item">
											<img src="{{ asset('image/UI-BACKEND/carousel/banner_7.jpg') }}"
												alt="image" />
										</div>
										<div class="item">
											<img src="{{ asset('image/UI-BACKEND/carousel/banner_8.jpg') }}"
												alt="image" />
										</div>
										<div class="item">
											<img src="{{ asset('image/UI-BACKEND/carousel/banner_8.jpg') }}"
										...
										<div class="item">
											<img src="{{ asset('image/UI-BACKEND/carousel/banner_10.jpg') }}"
												alt="image" />
										</div>
										<div class="item">
											<img src="{{ asset('image/UI-BACKEND/carousel/banner_5.jpg') }}"
												alt="image" />
										</div>
										<div class="item">
											<img src="{{ asset('image/UI-BACKEND/carousel/banner_12.jpg') }}"
							...
							<div class="card">
								<div class="card-body">
									...
									<div class="owl-carousel owl-theme nonloop">
										<div class="item">
											<img src="{{ asset('image/UI-BACKEND/carousel/banner_3.jpg') }}"
												alt="image" />
										</div>
										<div class="item">
											<img src="{{ asset('image/UI-BACKEND/carousel/banner_5.jpg') }}"
										...
										<div class="item">
											<img src="{{ asset('image/UI-BACKEND/carousel/banner_6.jpg') }}."
												alt="image" />
										</div>
										<div class="item">
											<img src="{{ asset('image/UI-BACKEND/carousel/banner_8.jpg') }}"
							...
							<div class="card">
								<div class="card-body">
									...
									<div class="owl-carousel owl-theme lazy-load">
										<img class="owl-lazy"
											src="{{ asset('image/UI-BACKEND/carousel/banner_8.jpg') }}"
											data-src="{{ asset('image/UI-BACKEND/carousel/banner_8.jpg') }}"
											data-src-retina="{{ asset('image/UI-BACKEND/carousel/banner_8.jpg') }}"
											alt="image" /> 
										<img class="owl-lazy"
											src="{{ asset('image/UI-BACKEND/carousel/banner_10.jpg') }}"
											data-src="{{ asset('image/UI-BACKEND/carousel/banner_10.jpg') }}"
											data-src-retina="{{ asset('image/UI-BACKEND/carousel/banner_10.jpg') }}"
											alt="image" /> 
										<img class="owl-lazy"
											src="{{ asset('image/UI-BACKEND/carousel/banner_8.jpg') }}"
											data-src="{{ asset('image/UI-BACKEND/carousel/banner_8.jpg') }}"
								...
								<div class="card-body">
									...
									<div class="owl-carousel owl-theme video-carousel">
										<div class="item-video">
											<a class="owl-video"
												href="https://www.youtube.com/watch?v=9JBNmGlEdLY"></a>
										</div>
										<div class="item-video">
											<a class="owl-video"
												href="https://www.youtube.com/watch?v=Pq9yPrLWMyU"></a>
										</div>
										<div class="item-video">
											<a class="owl-video"
												href="https://www.youtube.com/watch?v=yWd4mzGqQYo"></a>
										</div>
										<div class="item-video">
											<a class="owl-video"
												href="https://www.youtube.com/watch?v=8Tc7PMuHTJQ"></a>
										</div>
									</div>
								</div>
							</div>
	...
	<script src="{{ asset('js/UI-BACKEND/vendors/owl-carousel-2/owl.carousel.min.js') }}"></script>
	...
	<script src="{{ asset('js/UI-BACKEND/owl-carousel.js') }}"></script>

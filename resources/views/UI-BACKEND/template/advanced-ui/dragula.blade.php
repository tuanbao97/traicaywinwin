...
<link rel="stylesheet" href="{{ asset('css/UI-BACKEND/vendors/dragula/dragula.min.css') }}">
...
<body>
						...
						<div class="col-12 grid-margin">
							<div class="card">
								<div class="card-body">
									...
									<p class="card-description">Drag and drop between Team A and
										Team B</p>
									<div class="row">
												...
												<div id="profile-list-left" class="py-2">
													<div class="card rounded mb-2">
														<div class="card-body p-3">
															<div class="media">
																<img src="{{ asset('image/UI-BACKEND/faces/face5.jpg') }}"
																	alt="image" class="img-sm me-3 rounded-circle">
											...
											<div class="bg-secondary p-4">
												...
												<div id="profile-list-right" class="py-2">
													...
													<div class="card rounded mb-2">
														<div class="card-body p-3">
															<div class="media">
																<img src="{{ asset('image/UI-BACKEND/faces/face7.jpg') }}"
																	alt="image" class="img-sm me-3 rounded-circle">
																<div class="media-body">
													...
													<div class="card rounded mb-2">
														<div class="card-body p-3">
															<div class="media">
																<img src="{{ asset('image/UI-BACKEND/faces/face8.jpg') }}"
																	alt="image" class="img-sm me-3 rounded-circle">
																<div class="media-body">
						...
						<div class="col-12 grid-margin">
							<div class="card">
								<div class="card-body">
									...
									<p class="card-description">Drag and drop tasks from todo to
										in-progress or vice-versa</p>
									<div class="row">
										<div class="col-md-6">
											...
											<div id="dragula-left" class="py-2">
												<div class="card rounded border mb-2">
													<div class="card-body p-3">
														<div class="media">
															<i
																class="typcn typcn-device-laptop icon-sm align-self-center me-3"></i>
															<div class="media-body">
																<h6 class="mb-1">Build wireframe</h6>
																<p class="mb-0 text-muted">Build wireframe for the new
																	app</p>
															</div>
														</div>
													</div>
												...
												<div class="card rounded border mb-2">
													<div class="card-body p-3">
														<div class="media">
															<i
																class="typcn typcn-document icon-sm align-self-center me-3"></i>
															<div class="media-body">
												...
												<div class="card rounded border mb-2">
													<div class="card-body p-3">
														<div class="media">
															<i
																class="typcn typcn-upload icon-sm align-self-center me-3"></i>
															<div class="media-body">
																<h6 class="mb-1">Upload the new update</h6>
																<p class="mb-0 text-muted">Submit the new build in play
																	store</p>
															</div>
														</div>
													</div>
												...
												<div class="card rounded border mb-2">
													<div class="card-body p-3">
														<div class="media">
															<i
																class="typcn typcn-plane icon-sm align-self-center me-3"></i>
															<div class="media-body">
											...
											<div id="dragula-right" class="py-2">
												<div class="card rounded border mb-2">
													<div class="card-body p-3">
														<div class="media">
															<i
																class="typcn typcn-user icon-sm align-self-center me-3"></i>
															<div class="media-body">
																<h6 class="mb-1">Project details</h6>
																<p class="mb-0 text-muted">Get new project details from
																	Greg</p>
															</div>
														</div>
													</div>
												...
												<div class="card rounded border mb-2">
													<div class="card-body p-3">
														<div class="media">
															<i
																class="typcn typcn-th-small icon-sm align-self-center me-3"></i>
															<div class="media-body">
												...
												<div class="card rounded border mb-2">
													<div class="card-body p-3">
														<div class="media">
															<i
																class="typcn typcn-home-outline icon-sm align-self-center me-3"></i>
															<div class="media-body">
												...
												<div class="card rounded border mb-2">
													<div class="card-body p-3">
														<div class="media">
															<i
																class="typcn typcn-calendar-outline icon-sm align-self-center me-3"></i>
															<div class="media-body">
											...
											<div id="dragula-event-left" class="py-2">
												<div class="card rounded border mb-2">
													<div class="card-body p-3">
														<div class="media">
															<i
																class="typcn typcn-tick icon-sm text-primary align-self-center me-3"></i>
															<div class="media-body">
																<h6 class="mb-1">Build wireframe</h6>
																<p class="mb-0 text-muted">Build wireframe for the new
																	app</p>
											...
											<div id="dragula-event-right" class="py-2">
												<div class="card rounded border mb-2">
													<div class="card-body p-3">
														<div class="media">
															<i
																class="typcn typcn-input-checked icon-sm text-success align-self-center me-3"></i>
															<div class="media-body">
																<h6 class="mb-1">Project details</h6>
																<p class="mb-0 text-muted">Get new project details from
																	Greg</p>
	...
	<script src="{{ asset('js/UI-BACKEND/vendors/dragula/dragula.min.js') }}"></script>
	...
	<script src="{{ asset('js/UI-BACKEND/dragula.js') }}"></script>

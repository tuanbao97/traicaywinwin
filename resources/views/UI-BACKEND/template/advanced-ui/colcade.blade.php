...
<body>
						...
						<div class="col-lg-12">
							<div class="card">
								<div class="card-body">
									...
									<p class="card-description">Colcade works by moving item
										elements into column elements.</p>
									<div class="grid">
	...
	<script src="{{ asset('js/UI-BACKEND/vendors/colcade/colcade.js') }}"></script>
	...
	<script src="{{ asset('js/UI-BACKEND/tight-grid.js') }}"></script>

...
<body>
					...
					<div class="row">
						<div class="col-12 grid-margin">
							<div class="card">
								<div class="row">
									<div
										class="col-md-4 col-sm-6 d-flex justify-content-center border-right">
										<div class="card-body">
											<div class="wrapper text-center">
												<h4 class="card-title">Alerts Popups</h4>
												<p class="card-description">A basic message</p>
												<button class="btn btn-outline-success"
													onclick="showSwal('basic')">Click here!</button>
											</div>
										</div>
									</div>
									<div
										...
										<div class="card-body">
											<div class="wrapper text-center">
												...
												<button class="btn btn-outline-success"
													onclick="showSwal('title-and-text')">Click here!</button>
											</div>
										</div>
									</div>
									<div class="col-md-4 col-sm-6 d-flex justify-content-center">
										<div class="card-body">
											<div class="wrapper text-center">
												...
												<button class="btn btn-outline-success"
													onclick="showSwal('success-message')">Click here!</button>
											</div>
										</div>
									</div>
								</div>
									...
									<div
										...
										<div class="card-body">
											<div class="wrapper text-center">
												...
												<p class="card-description">A success message!</p>
												<button class="btn btn-outline-success"
													onclick="showSwal('warning-message-and-cancel')">Click
													here!</button>
											</div>
										</div>
									</div>
									<div class="col-md-4 col-sm-6 d-flex justify-content-center">
										<div class="card-body">
											<div class="wrapper text-center">
												...
												<button class="btn btn-outline-success"
													onclick="showSwal('auto-close')">Click here!</button>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="card-body">
									<div class="row">
										<div class="col-12 text-center">
											...
											<a href="#" id="show" class="btn btn-outline-danger">Click
												here!</a>
										</div>
									</div>
								</div>
	...
	<script src="{{ asset('js/UI-BACKEND/vendors/sweetalert/sweetalert.min.js') }}"></script>
  	<script src="{{ asset('js/UI-BACKEND/vendors/jquery.avgrund/jquery.avgrund.min.js') }}"></script>
	...
	<script src="{{ asset('js/UI-BACKEND/alerts.js') }}"></script>
  	<script src="{{ asset('js/UI-BACKEND/avgrund.js') }}"></script>

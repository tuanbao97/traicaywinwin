...
<link rel="stylesheet" href="{{ asset('css/UI-BACKEND/vendors/quill/quill.snow.css') }}">
<link rel="stylesheet"
	href="{{ asset('css/UI-BACKEND/vendors/simplemde/simplemde.min.css') }}">
...
<body>
	...
	<script src="{{ asset('js/UI-BACKEND/vendors/tinymce/tinymce.min.js') }}"></script>
	<script src="{{ asset('js/UI-BACKEND/vendors/quill/quill.min.js') }}"></script>
	<script src="{{ asset('js/UI-BACKEND/vendors/simplemde/simplemde.min.js') }}"></script>
	...
	<script src="{{ asset('js/UI-BACKEND/editorDemo.js') }}"></script>

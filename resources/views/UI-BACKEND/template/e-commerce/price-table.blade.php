							...
							<div class="card">
								<div class="card-body">
									<div class="container text-center pt-5">
										...
										<p class="w-75 mx-auto mb-5">Choose a plan that suits you the
											best. If you are not fully satisfied, we offer 30-day
											money-back guarantee no questions asked!!</p>
										<div class="row pricing-table">
											<div
												class="col-md-6 col-xl-4 grid-margin stretch-card pricing-card">
											...
											<div
												...
												<div class="card border border-primary pricing-card-body">
													...
													<div class="wrapper">
														<a href="#" class="btn btn-outline-primary btn-block">Start
															trial</a>
													</div>

								...
								<div class="card-body">
									...
									<div class="container-fluid d-flex justify-content-between">
										<div class="col-lg-3 pl-0">
											...
											<p>
												104,<br>Minare SK,<br>Canada, K1A 0G9.
											</p>
										</div>
										<div class="col-lg-3 pr-0">
											<p class="mt-5 mb-2 text-end">
												<b>Invoice to</b>
											</p>
											<p class="text-end">
												Gaala & Sons,<br> C-201, Beykoz-34800,<br> Canada, K1A 0G9.
											</p>
										</div>
									</div>
									<div class="container-fluid d-flex justify-content-between">
											...
											<table class="table">
												...
												<tbody>
													...
													<tr class="text-end">
														...
														<td class="text-start">Web Design Packages(Template) -
															Basic</td>
														<td>05</td>
														<td>$25</td>
														<td>$125</td>
									...
									<div class="container-fluid w-100">
										<a href="#" class="btn btn-primary float-right mt-4 ms-2"><i
											class="typcn typcn-printer mr-1"></i>Print</a> <a href="#"
											class="btn btn-success float-right mt-4"><i
											class="typcn typcn-export mr-1"></i>Send Invoice</a>
									</div>
								</div>
							</div>
						</div>

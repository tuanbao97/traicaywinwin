											...
											<div class="row portfolio-grid">
												<div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12">
													<figure class="effect-text-in">
														<img src="{{ asset('image/UI-BACKEND/samples/300x300/5.jpg') }}"
															alt="image" />
														<figcaption>
															<h4>Photography</h4>
												...
												<div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12">
													<figure class="effect-text-in">
														<img src="{{ asset('image/UI-BACKEND/samples/300x300/2.jpg') }}"
															alt="image" />
														<figcaption>
															<h4>Lifestyle</h4>
															<p>Lorem ipsum dolor sit amet, consectetur adipiscing
												...
												<div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12">
													<figure class="effect-text-in">
														<img src="{{ asset('image/UI-BACKEND/samples/300x300/3.jpg') }}"
															alt="image" />
														<figcaption>
															<h4>Tech Geeks</h4>
															<p>Lorem ipsum dolor sit amet, consectetur adipiscing
												...
												<div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12">
													<figure class="effect-text-in">
														<img src="{{ asset('image/UI-BACKEND/samples/300x300/4.jpg') }}"
															alt="image" />
														<figcaption>
															<h4>Explore World</h4>
															<p>Lorem ipsum dolor sit amet, consectetur adipiscing
												...
												<div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12">
													<figure class="effect-text-in">
														<img src="{{ asset('image/UI-BACKEND/samples/300x300/6.jpg') }}"
															alt="image" />
														<figcaption>
															<h4>Colors</h4>
															<p>Lorem ipsum dolor sit amet, consectetur adipiscing
												...
												<div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12">
													<figure class="effect-text-in">
														<img src="{{ asset('image/UI-BACKEND/samples/300x300/7.jpg') }}"
															alt="image" />
														<figcaption>
												...
												<div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12">
													<figure class="effect-text-in">
														<img src="{{ asset('image/UI-BACKEND/samples/300x300/8.jpg') }}"
															alt="image" />
														<figcaption>
															<h4>World</h4>
															<p>Lorem ipsum dolor sit amet, consectetur adipiscing
												...
												<div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12">
													<figure class="effect-text-in">
														<img src="{{ asset('image/UI-BACKEND/samples/300x300/9.jpg') }}"
															alt="image" />
														<figcaption>
															<h4>Cultures</h4>
															<p>Lorem ipsum dolor sit amet, consectetur adipiscing
												...
												<div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12">
													<figure class="effect-text-in">
														<img src="{{ asset('image/UI-BACKEND/samples/300x300/11.jpg') }}"
															alt="image" />
														<figcaption>
												...
												<div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12">
													<figure class="effect-text-in">
														<img src="{{ asset('image/UI-BACKEND/samples/300x300/12.jpg') }}"
															alt="image" />
														<figcaption>
															<h4>Nature</h4>
															<p>Lorem ipsum dolor sit amet, consectetur adipiscing
												...
												<div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12">
													<figure class="effect-text-in">
														<img src="{{ asset('image/UI-BACKEND/samples/300x300/13.jpg') }}"
															alt="image" />
														<figcaption>
															<h4>Routines</h4>
															<p>Lorem ipsum dolor sit amet, consectetur adipiscing
												...
												<div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12">
													<figure class="effect-text-in">
														<img src="{{ asset('image/UI-BACKEND/samples/300x300/14.jpg') }}"
															alt="image" />
														<figcaption>
															<h4>Life</h4>
															<p>Lorem ipsum dolor sit amet, consectetur adipiscing
												...
												<div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12">
													<figure class="effect-text-in">
														<img src="{{ asset('image/UI-BACKEND/samples/300x300/15.jpg') }}"
															alt="image" />
														<figcaption>
															<h4>Vision</h4>
															<p>Lorem ipsum dolor sit amet, consectetur adipiscing

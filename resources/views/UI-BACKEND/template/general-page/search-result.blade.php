								...
								<div class="card-body">
									<div class="row">
											...
											<form action="#">
												<div class="form-group d-flex">
													<input type="text" class="form-control"
														placeholder="Search Here" value="Bootstrapdash">
										...
										<div class="col-12 mb-5">
											<h2>
												Search Result For<u class="ms-2">"Bootstrapdash"</u>
											</h2>
											<p class="text-muted">About 12,100 results (0.52 seconds)</p>
										</div>
										<div class="col-12 results">
											<div class="pt-4 border-bottom">
												<a class="d-block h4" href="#">Bootstrapdash</a> <a
													class="page-url text-primary" href="#">https://www.bootstrapdash.com/</a>
												<p class="page-description mt-1 w-75 text-muted">Bootstrapdash
													gives you the most beautiful, free and premium bootstrap
													admin dashboard templates and control panel themes based on
													Bootstrap 3 and 4.</p>
											</div>
										</div>
										<div class="col-12 results">
											<div class="pt-4 border-bottom">
												<a class="d-block h4" href="#">Bootstrapdash Team – Medium</a>
												<a class="page-url text-primary" href="#">https://medium.com/@bootstrapdash</a>
												<p class="page-description mt-1 w-75 text-muted">Read
													writing from Bootstrapdash Team on Medium. We design and
													develop awesome admin dashboard templates with Bootstrap,
													so you can kick-start and speed up your development.
													www.bootstrapdash.com.</p>
											</div>
										</div>
										<div class="col-12 results">
											<div class="pt-4 border-bottom">
												<a class="d-block h4" href="#">Bootstrapdash · GitHub</a> <a
													class="page-url text-primary" href="#">https://github.com/bootstrapdash</a>
												<p class="page-description mt-1 w-75 text-muted">Bootstrapdash
													has 1 repository available. Follow their code on GitHub.</p>
											</div>
										</div>
										<div class="col-12 results">
											<div class="pt-4 border-bottom">
												<a class="d-block h4" href="#">bootstrapdash.com - Home |
													Facebook</a> <a class="page-url text-primary" href="#">https://www.facebook.com/bootstrapdash</a>
												<p class="page-description mt-1 w-75 text-muted">Bootstrapdash.com.
													9 likes · 4 talking about this. Clean, customisable admin
													dashboard template themes / UI WebApp Kits with a huge
													collection of...</p>
											</div>
										</div>
										<div class="col-12 results">
											<div class="pt-4 border-bottom">
												<a class="d-block h4" href="#">Bootstrapdash Team – Hacker
													Noon</a> <a class="page-url text-primary" href="#">https://hackernoon.com/@bootstrapdash</a>
												<p class="page-description mt-1 w-75 text-muted">Oct 9, 2017
													- Read writing from Bootstrapdash Team in Hacker Noon. We
													design and develop awesome admin dashboard templates with
													Bootstrap, so you can kick-start and speed up your
													development. www.bootstrapdash.com.</p>
											</div>
										</div>
										<div class="col-12 results">
											<div class="pt-4 border-bottom">
												<a class="d-block h4" href="#">Bootstrapdash | Crunchbase</a>
												<a class="page-url text-primary" href="#">https://www.crunchbase.com/organization/bootstrapdash</a>
												<p class="page-description mt-1 w-75 text-muted">Bootstrapdash
													creates quality admin templates that are based on
													Bootstrap, the most popular front end development
													framework.</p>
											</div>
										</div>
										<div class="col-12 results">
											<div class="pt-4 border-bottom">
												<a class="d-block h4" href="#">Bootstrapdash.com
													(@bootstrapdash) | Twitter</a> <a
													class="page-url text-primary" href="#">https://twitter.com/@bootstrapdash</a>
												<p class="page-description mt-1 w-75 text-muted">The latest
													Tweets from bootstrapdash.com (@bootstrapdash). Clean,
										...
										<div class="col-12 results">
											<div class="pt-4 border-bottom">
												<a class="d-block h4" href="#">Bootstrapdash on Behance</a>
												<a class="page-url text-primary" href="#">https://www.behance.net/bootstrapdash</a>
												<p class="page-description mt-1 w-75 text-muted">Awesome
													Bootstrap Admin Dashboard Templates. For Faster, Easier Web
													Applications Development. Clean, customizable admin
													dashboard template theme / UI WebApp Kit with a huge

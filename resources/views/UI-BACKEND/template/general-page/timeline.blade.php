										...
										<div class="timeline">
											<div class="timeline-wrapper timeline-wrapper-warning">
												...
												<div class="timeline-panel">
													...
													<div class="timeline-body">
														<p>Two years in the making, we finally have our first beta
															release of Bootstrap 5.</p>
													</div>
													<div
														class="timeline-footer d-flex align-items-center flex-wrap">
														<i class="typcn typcn-heart-outline text-muted mr-1"></i>
														<span>19</span> <span class="ml-md-auto font-weight-bold">19
															Oct 2017</span>
													</div>
												</div>
											</div>
											<div
												class="timeline-wrapper timeline-inverted timeline-wrapper-danger">
												<div class="timeline-badge"></div>
												<div class="timeline-panel">
													<div class="timeline-heading">
													...
													<div class="timeline-body">
														<p>Alpha 6 has landed, and it’s one of our biggest ships
															to date.</p>
													</div>
													<div
														class="timeline-footer d-flex align-items-center flex-wrap">
														<i class="typcn typcn-heart-outline text-muted mr-1"></i>
														<span>25</span> <span class="ml-md-auto font-weight-bold">10th
															Aug 2017</span>
													</div>
												</div>
											</div>
											<div class="timeline-wrapper timeline-wrapper-success">
												...
												<div class="timeline-panel">
													...
													<div class="timeline-body">
														<p>Alpha 5 has arrived just over a month after Alpha 4
															with some major feature improvements and a boat load of
															bug fixes.</p>
													</div>
													<div
														class="timeline-footer d-flex align-items-center flex-wrap">
														<i class="typcn typcn-heart-outline text-muted mr-1"></i>
														<span>19</span> <span class="ml-md-auto font-weight-bold">5th
															Sep 2016</span>
													</div>
												</div>
											</div>
											<div
												...
												<div class="timeline-panel">
													...
													<div class="timeline-body">
														<p>Alpha 4 is here to address those pesky build and
															package errors, a few CSS bugs, and some documentation
															inconsistencies we introduced in our last release.</p>
													</div>
													<div
														class="timeline-footer d-flex align-items-center flex-wrap">
														<i class="typcn typcn-heart-outline text-muted mr-1"></i>
														<span>19</span> <span class="ml-md-auto font-weight-bold">27th
															July 2016</span>
													</div>
												</div>
											</div>
											<div class="timeline-wrapper timeline-wrapper-primary">
												...
												<div class="timeline-panel">
													...
													<div class="timeline-body">
														<p>Alpha 3 has landed! We have an overhauled grid, updated
															form controls, a new font stack, tons of bug fixes, and
															more.</p>
													</div>
													<div
														class="timeline-footer d-flex align-items-center flex-wrap">
														<i class="typcn typcn-heart-outline text-muted mr-1"></i>
														<span>25</span> <span class="ml-md-auto font-weight-bold">25th
															July 2016</span>
													</div>
												</div>
											</div>
											<div
												...
												<div class="timeline-panel">
													...
													<div class="timeline-body">
														<p>The general plan for v4’s development starts with a few
															alpha releases. We’re a little behind on that, but should
															be getting caught up as the year winds down.</p>
													</div>
													<div
														class="timeline-footer d-flex align-items-center flex-wrap">
														<i class="typcn typcn-heart-outline text-muted mr-1"></i>
														<span>32</span> <span class="ml-md-auto font-weight-bold">19th
															Aug 2015</span>
													</div>
												</div>
											</div>
											<div class="timeline-wrapper timeline-wrapper-success">
												...
												<div class="timeline-panel">
													...
													<div class="timeline-body">
														<p>Bootstrap 5 has been a massive undertaking that touches
															nearly every line of code.</p>
													</div>
													<div
														class="timeline-footer d-flex align-items-center flex-wrap">
														<i class="typcn typcn-heart-outline text-muted mr-1"></i>
														<span>26</span> <span class="ml-md-auto font-weight-bold">15th
															Jun 2015</span>
													</div>
												</div>
											</div>

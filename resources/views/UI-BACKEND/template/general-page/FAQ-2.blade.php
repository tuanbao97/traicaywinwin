									...
									<form action="#">
										<div class="form-group d-flex search-field">
											<input type="text" class="form-control"
												placeholder="Search Here" value="Sass tutorial">
													...
													<div class="card-header" id="headingOne">
														<h5 class="mb-0">
															<a data-bs-toggle="collapse"
																...
																aria-controls="collapseOne"> How many instances of Lorum
																Ipsum usage can be found on the web? </a>
														</h5>
													</div>
                      ...
                      <div id="accordion-4" class="accordion">
                        <div class="card">
                          <div class="card-header" id="headingOne-4">
                            <h5 class="mb-0">
                              <a data-bs-toggle="collapse"
																data-bs-target="#collapseOne-4" aria-expanded="true"
																aria-controls="collapseOne-4">
                                Can I transfer the money from the wallet to my bank account?
                              </a>
                            </h5>
                          </div>
                          <div id="collapseOne-4" class="collapse show"
                        ...
                        <div class="card">
                          ...
                          <div id="collapseTwo-4" class="collapse"
                        ...
                        <div class="card">
                          ...
                          <div id="collapseThree-4" class="collapse"
            ...
            <div class="card">
                <div class="card-body">
                    <div
                        ...
                        <span
									class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © 2023 <a
									href="https://www.bootstrapdash.com/" class="text-muted"
									target="_blank">Bootstrapdash</a>. All rights reserved.</span>
                        <span
									class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center text-muted">Hand-crafted & made with <i

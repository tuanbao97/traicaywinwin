												...
												<div class="card-header" id="headingOne">
													<h5 class="mb-0">
														<a data-bs-toggle="collapse" data-bs-target="#collapseOne"
															...
															many instances of Lorum Ipsum usage can be found on the
															web? </a>
													</h5>
												</div>
												...
												<div class="card-header" id="headingTwo">
													<h5 class="mb-0">
														<a data-bs-toggle="collapse" data-bs-target="#collapseTwo"
															...
															is Lorum Ipsum and who invented it? </a>
													</h5>
												</div>
												<div id="collapseTwo" class="collapse"
													aria-labelledby="headingTwo" data-bs-parent="#accordion-1">
													<div class="card-body">
														<p class="mb-0">Anim pariatur cliche reprehenderit, enim
															eiusmod high life accusamus terry richardson ad squid. 3
															wolf moon officia aute, non cupidatat skateboard dolor
												...
												<div class="card-header" id="headingThree">
													<h5 class="mb-0">
														<a data-bs-toggle="collapse"
															...
															aria-controls="collapseThree"> How may times Lorum Ipsum
															has been used in this theme? </a>
													</h5>
												</div>
										...
										<div id="accordion-2" class="accordion">
											<div class="card">
												<div class="card-header" id="headingOne-2">
													<h5 class="mb-0">
														<a data-bs-toggle="collapse"
															data-bs-target="#collapseOne-2" aria-expanded="true"
															aria-controls="collapseOne-2"> How many instances of
															Lorum Ipsum usage can be found on the web? </a>
													</h5>
												</div>
												...
												<div class="card-header" id="headingTwo-2">
													<h5 class="mb-0">
														<a data-bs-toggle="collapse"
															...
															aria-controls="collapseTwo-2"> What is Lorum Ipsum and
															who invented it? </a>
													</h5>
												</div>
												...
												<div class="card-header" id="headingThree-2">
													<h5 class="mb-0">
														<a data-bs-toggle="collapse"
															...
															aria-controls="collapseThree-2"> How may times Lorum
															Ipsum has been used in this theme? </a>
													</h5>
												</div>
												<div id="collapseThree-2" class="collapse"
										...
										<div id="accordion-3" class="accordion">
											<div class="card">
												<div class="card-header" id="headingOne-3">
													<h5 class="mb-0">
														<a data-bs-toggle="collapse"
															data-bs-target="#collapseOne-3" aria-expanded="true"
															aria-controls="collapseOne-3"> How many instances of
															Lorum Ipsum usage can be found on the web? </a>
													</h5>
												</div>
												<div id="collapseOne-3" class="collapse show"
												...
												<div class="card-header" id="headingTwo-3">
													<h5 class="mb-0">
														<a data-bs-toggle="collapse"
															...
															aria-controls="collapseTwo-3"> What is Lorum Ipsum and
															who invented it? </a>
													</h5>
												</div>
												<div id="collapseTwo-3" class="collapse"
												...
												<div class="card-header" id="headingThree-3">
													<h5 class="mb-0">
														<a data-bs-toggle="collapse"
															...
															aria-controls="collapseThree-3"> How may times Lorum
															Ipsum has been used in this theme? </a>
													</h5>
												</div>
												<div id="collapseThree-3" class="collapse"

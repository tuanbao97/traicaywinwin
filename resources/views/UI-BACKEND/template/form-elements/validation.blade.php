...
<body>
									...
									<form class="cmxform" id="commentForm" method="get" action="#">
										<fieldset>
											<div class="form-group">
												...
												<input id="cname" class="form-control" name="name"
	...
	<!-- Plugin js for this page-->
  	...
  	<script src="{{ asset('js/UI-BACKEND/vendors/bootstrap-maxlength/bootstrap-maxlength.min.js') }} "></script>
	...
	<!-- Custom js for this page-->
  	<script src="{{ asset('js/UI-BACKEND/form-validation.js') }} "></script>
  	<script src="{{ asset('js/UI-BACKEND/bt-maxLength.js') }} "></script>

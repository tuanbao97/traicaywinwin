...
<body>
									...
									<form id="example-form" action="#">
										<div>
											...
											<section>
												<h3>Profile</h3>
												<div class="form-group">
													<label>First name</label> <input type="email"
														class="form-control" aria-describedby="emailHelp"
												...
												<div class="form-group">
													<label>Profession</label> <input type="password"
											...
											<section>
												...
												<div class="form-check">
													<label class="form-check-label"> <input class="checkbox"
														type="checkbox"> I agree with the Terms and Conditions.
													</label>
												</div>
											</section>
										</div>
											...
											<section>
												...
												<div class="form-group">
													<label for="confirm">Confirm Password *</label> <input
														...
														class="required form-control"> <small>(*) Mandatory</small>
												</div>
											</section>
											<h3>Profile</h3>
											<section>
												...
												<div class="form-group">
													<label for="name">First name *</label> <input id="name"
														name="name" type="text" class="required form-control">
												</div>
												<div class="form-group">
												...
												<div class="form-group">
													<label for="address">Address</label> <input id="address"
														name="address" type="text" class="form-control"> <small>(*)
														Mandatory</small>
												</div>
											</section>
											<h3>Finish</h3>
	...
	<!-- Plugin js for this page-->
  	<script src="{{ asset('js/UI-BACKEND/vendors/jquery-steps/jquery.steps.min.js') }}"></script>
  	<script src="{{ asset('js/UI-BACKEND/vendors/jquery-validation/jquery.validate.min.js') }}"></script>
	...
	<script src="{{ asset('js/UI-BACKEND/wizard.js') }}"></script>

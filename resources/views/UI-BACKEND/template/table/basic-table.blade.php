									...
									<div class="table-responsive">
										<table class="table table-striped">
											...
											<tbody>
												<tr>
													<td class="py-1"><img
														src="{{ asset('image/UI-BACKEND/faces/face1.jpg') }}" alt="image" /></td>
													<td>Herman Beck</td>
													<td>
														<div class="progress">
												...
												<tr>
													<td class="py-1"><img
														src="{{ asset('image/UI-BACKEND/faces/face2.jpg') }}" alt="image" /></td>
													<td>Messsy Adam</td>
													<td>
														<div class="progress">
												...
												<tr>
													<td class="py-1"><img
														src="{{ asset('image/UI-BACKEND/faces/face3.jpg') }}" alt="image" /></td>
													<td>John Richards</td>
													<td>
														<div class="progress">
												...
												<tr>
													<td class="py-1"><img
														src="{{ asset('image/UI-BACKEND/faces/face4.jpg') }}" alt="image" /></td>
													<td>Peter Meggik</td>
													<td>
														<div class="progress">
												...
												<tr>
													<td class="py-1"><img
														src="{{ asset('image/UI-BACKEND/faces/face5.jpg') }}" alt="image" /></td>
													<td>Edward</td>
													<td>
														<div class="progress">
															<div class="progress-bar bg-danger" role="progressbar"

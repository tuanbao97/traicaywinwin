...
<body>
										...
										<div class="table-sorter-wrapper col-lg-12 table-responsive">
											<table id="sortable-table-1" class="table">
												<thead>
													<tr>
														<th>#</th>
														<th class="sortStyle">First Name<i
															class="typcn typcn-arrow-sorted-down"></i></th>
														<th class="sortStyle">Last Name<i
															class="typcn typcn-arrow-sorted-down"></i></th>
														<th class="sortStyle">Product<i
															class="typcn typcn-arrow-sorted-down"></i></th>
														<th class="sortStyle">Amount<i
															class="typcn typcn-arrow-sorted-down"></i></th>
														<th class="sortStyle">Deadline<i
															class="typcn typcn-arrow-sorted-down"></i></th>
													</tr>
												</thead>
												<tbody>
	...
	<script src="{{ asset('js/UI-BACKEND/jq.tablesort.js') }}"></script>
	...
	<script src="{{ asset('js/UI-BACKEND/tablesorter.js') }}"></script>

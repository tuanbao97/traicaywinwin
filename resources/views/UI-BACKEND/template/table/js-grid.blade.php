...
<link rel="stylesheet" href="{{ asset('css/UI-BACKEND/vendors/jsgrid/jsgrid.min.css') }}">
<link rel="stylesheet" href="{{ asset('css/UI-BACKEND/vendors/jsgrid/jsgrid-theme.min.css') }}">
...
<body>
							...
							<div class="card">
								<div class="card-body">
									...
									<div class="sort-panel d-flex align-items-ceter mb-4 pt-3">
										<label class="d-flex justify-content-start mb-0"> Sorting
											Field: <select id="sortingField"
											class="form-control form-control-sm me-2 ms-2 w-25">
												<option>Name</option>
												<option>Age</option>
	...
	<script src="{{ asset('js/UI-BACKEND/vendors/jsgrid/jsgrid.min.js') }}"></script>
	...
	<script src="{{ asset('js/UI-BACKEND/js-grid.js') }}"></script>
  	<script src="{{ asset('js/UI-BACKEND/db.js') }}"></script>

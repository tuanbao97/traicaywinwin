...
<body>
							...
							<div class="card">
								<div class="card-body">
									...
									<div class="container text-center">
										...
										<a href="#" class="btn btn-success" id="g2_refresh">Random
											Refresh</a>
									</div>
								</div>
							</div>
								...
								<div class="card-body">
									...
									<div class="row text-center d-flex justify-content-center">
										<button type="button" class="btn btn-success mt-4"
											id="gauge_refresh">Refresh Gauges</button>
									</div>
								</div>
							</div>
						</div>
	...
	<script src="{{ asset('js/UI-BACKEND/vendors/justgage/raphael-2.1.4.min.js') }}"></script>
  	<script src="{{ asset('js/UI-BACKEND/vendors/justgage/justgage.js') }}"></script>
	...
	<script src="{{ asset('js/UI-BACKEND/just-gage.js') }}"></script>

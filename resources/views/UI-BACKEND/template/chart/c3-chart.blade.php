...
<link rel="stylesheet" href="{{ asset('css/UI-BACKEND/vendors/c3/c3.min.css') }}">
...
<body>
	...
	<!-- Plugin js for this page-->
  	<script src="{{ asset('js/UI-BACKEND/vendors/d3/d3.min.js') }}"></script>
  	<script src="{{ asset('js/UI-BACKEND/vendors/c3/c3.js') }}"></script>
	...
	<script src="{{ asset('js/UI-BACKEND/c3.js') }}"></script>

...
<link rel="stylesheet" href="{{ asset('css/UI-BACKEND/vendors/morris.js/morris.css') }}">
...
<body>
	...
	<script src="{{ asset('js/UI-BACKEND/vendors/raphael/raphael.min.js') }}"></script>
  	<script src="{{ asset('js/UI-BACKEND/vendors/morris.js/morris.min.js') }}"></script>
	...
	<script src="{{ asset('js/UI-BACKEND/morris.js') }}"></script>
